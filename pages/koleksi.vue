        ...
        <div class="flex flex-col lg:flex-row gap-6">
          ...
          <div class="lg:w-3/4">
            ...
            <div v-else class="space-y-4">
              <div v-for="item in koleksi.data" :key="item.id" class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-200 relative">
                <div class="p-6">
                  <!-- Header with category and date -->
                  <div class="flex justify-between items-start">
                    <div class="flex items-center space-x-2 mb-1">
                      <span v-if="item.kategoriBangKom" class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                        {{ item.kategoriBangKom }}
                      </span>
                      <span v-if="item.jenis_dokumen" class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                        {{ item.jenis_dokumen }}
                      </span>
                    </div>
                  </div>
                  ...
                  <!-- Title -->
                  <NuxtLink :to="`/detail/${item.id}`" class="text-lg font-medium text-gray-900 hover:text-blue-600 line-clamp-2">
                    {{ item.judul }}
                  </NuxtLink>
                  ...
                  <div class="flex items-center gap-3 text-gray-500 text-sm mb-3">
                    ...
                    <div class="h-4 w-px bg-gray-300"></div>
                    <div>
                      <span v-if="item.youtube_link" class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-red-100 text-red-800">
                      ...
                      <span v-else-if="item.dokumen_pdf" class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-orange-100 text-orange-800">
                  ...
                  <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2">
                      <button @click="confirmToggleFavorite(item.id)" class="inline-flex items-center px-3 py-1.5 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" :class="{ 'text-yellow-500 fill-yellow-500': isFavorite(item.id), 'text-gray-400': !isFavorite(item.id) }" viewBox="0 0 24 24" stroke="currentColor">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
                        </svg>
                        Favorit
                      </button>
                      
                      <button @click="openShareModal(item)" class="inline-flex items-center px-3 py-1.5 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    ...
                    <NuxtLink :to="`/detail/${item.id}`" class="hidden md:inline-flex items-center px-2 py-1.5 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-800 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                      Lihat Detail
              ...
              <div class="mt-6">
                ...
                <div class="flex sm:hidden justify-between items-center">
                  <button @click="goToPrevPage" :disabled="!prevPageUrl" class="flex items-center gap-1 px-3 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed">
                ...
                <button @click="goToNextPage" :disabled="!nextPageUrl" class="flex items-center gap-1 px-3 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed">
                  Next
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div class="hidden sm:flex justify-between items-center">
                <div class="flex items-center gap-2">
                  ...
                  <button @click="goToPrevPage" :disabled="!prevPageUrl" class="flex items-center px-3 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="flex items-center gap-2">
                  <button @click="goToNextPage" :disabled="!nextPageUrl" class="flex items-center px-3 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed">
                    Next
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
