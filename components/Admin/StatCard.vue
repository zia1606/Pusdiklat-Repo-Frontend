<template>
  <div 
    class="bg-white rounded-xl shadow p-6 transition-all duration-300 hover:shadow-lg hover:scale-[1.02] cursor-pointer"
    :class="`border-t-4 border-${color}-500`"
    @click="$emit('click')"
  >
    <div class="flex items-start justify-between">
      ...
      <div class="p-3 rounded-full" :class="`bg-${color}-100`">
        <svg 
