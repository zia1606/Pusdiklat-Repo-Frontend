                    ...
                    <div class="p-10">
                        <div class="max-w-6xl mx-auto">
                            ...
                            <div class="flex flex-col sm:flex-row justify-between items-center mb-10 gap-4">
                                <div>
                                    <h2 class="text-2xl font-black text-gray-900 tracking-tight">Kategori BangKom</h2>
                                    <p class="text-[11px] font-bold text-gray-400 uppercase tracking-[0.2em] mt-1">Klasifikasi Pengembangan Kompetensi</p>
                                </div>
                                <button 
                                    @click="openAddModal" 
                                    ...
                                    <table class="w-full text-left border-collapse">
                                        <thead>
                                            <tr class="bg-gray-50/50 border-b border-gray-50">
                                                ...
                                                <th class="py-5 px-6 text-[11px] font-bold text-gray-400 uppercase tracking-widest">Nama Kategori</th>
                                        ...
                                        <tbody class="divide-y divide-gray-50">
                                            <tr v-for="(item, index) in kategoriWithCounts" :key="item.id" class="hover:bg-blue-50/30 transition-all duration-200 group">
                                            ...
                                            <tr v-if="kategoriWithCounts.length === 0">
            ...
            <div class="bg-white rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden transform transition-all animate-modalIn">
                ...
                <div class="relative overflow-hidden bg-blue-600 px-8 py-8">
                    ...
                    <div class="relative z-10 flex items-center space-x-4">
                        ...
                        <div>
                            <h3 class="text-lg font-black text-white tracking-tight">{{ isEditMode ? 'Edit Kategori' : 'Tambah Kategori' }}</h3>
                            <p class="text-blue-100 text-xs font-medium mt-0.5">{{ isEditMode ? 'Perbarui informasi kategori' : 'Buat kategori kompetensi baru' }}</p>
                        </div>
                    </div>
                </div>

                <div class="p-8">
                    <form @submit.prevent="isEditMode ? updateKategori() : addKategori()" class="space-y-6">
                        <div class="space-y-2">
                            <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1" for="nama">Nama Kategori</label>
                            <input 
                                v-model="form.nama" 
                                type="text" 
                                id="nama" 
                                ...
                                placeholder="Contoh: Teknis Statistik"
                                required
                            >
                        </div>
        ...
        <div v-if="showDeleteModal" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/60 backdrop-blur-sm transition-all duration-300">
            <div class="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden transform transition-all animate-modalIn">
                <div class="p-8 text-center">
                    ...
                    <h3 class="text-xl font-black text-gray-900 mb-2">Hapus Kategori?</h3>
                    <p class="text-sm text-gray-500 font-medium leading-relaxed">Apakah Anda yakin ingin menghapus kategori ini? Tindakan ini <span class="text-red-600 font-bold">permanen</span> dan tidak dapat dibatalkan.</p>
                </div>
